...
export const linkedListsProblems: SeedProblem[] = [
    // ==================== EASY #1: Reverse Linked List ====================
    {
        ...
        examples: [
            { title: "Example 1", input: "5\n1 2 3 4 5", output: "5 4 3 2 1", explanation: "1->2->3->4->5 reversed is 5->4->3->2->1." },
...
fn main() {
    ...
    // ==================== EASY #2: Find Middle Element ====================
    {
        ...
        examples: [
            { title: "Example 1", input: "5\n1 2 3 4 5", output: "3", explanation: "The middle node is 3." },
            { title: "Example 2", input: "6\n1 2 3 4 5 6", output: "4", explanation: "There are two middle nodes (3 and 4), the second one is 4." }
        ],
        testcases: [
            { input: "5\n1 2 3 4 5", output: "3" },
...
fn main() {
    ...
    // ==================== EASY #3: Detect Cycle ====================
    {
        ...
        examples: [
            { title: "Example 1", input: "4 1\n3 2 0 -4", output: "1", explanation: "There is a cycle where the tail connects to the index 1 node." },
...
fn main() {
    ...
    // ==================== EASY #5: Remove Nth Node from End ====================
    {
        ...
        examples: [
            { title: "Example 1", input: "5 2\n1 2 3 4 5", output: "1 2 3 5", explanation: "Removing the 2nd node from end (which is 4) results in 1->2->3->5." },
...
fn main() {
    ...
    {
        title: "Reorder List",
        description: "You are given the head of a singly linked list. Reorder the list to be in the following form: L0 → Ln → L1 → Ln-1 → L2 → Ln-2 → …\\n\\nYou must solve the problem without modifying the values in the list's nodes (i.e., only nodes themselves may be changed).\n\n**Input Format:**\n- First line: integer `n` (number of nodes)\n- Second line: `n` space-separated integers\n\n**Output Format:**\n- Space-separated integers representing the reordered list",
        difficulty: "MEDIUM",
        tags: ["linked-list", "two-pointers"],
        ...
        examples: [
            { title: "Example 1", input: "4\n1 2 3 4", output: "1 4 2 3", explanation: "1->2->3->4 is reordered to 1->4->2->3." },
...
fn main() {
    ...
    // ==================== MEDIUM #5: Rotate List by K ====================
    {
        ...
        examples: [
            { title: "Example 1", input: "5 2\n1 2 3 4 5", output: "4 5 1 2 3", explanation: "Rotate 2 steps: 4->5->1->2->3." },
...
fn main() {
    ...
    // ==================== HARD #1: Reverse in K-Groups ====================
    {
        ...
        examples: [
            { title: "Example 1", input: "5 2\n1 2 3 4 5", output: "2 1 4 3 5", explanation: "Reverse in groups of 2: [1,2] -> [2,1]; [3,4] -> [4,3]; [5] stays 5." },
            { title: "Example 2", input: "5 3\n1 2 3 4 5", output: "3 2 1 4 5", explanation: "[1,2,3] -> [3,2,1]; [4,5] stays 4->5." }
        ],
        testcases: [
            { input: "5 2\n1 2 3 4 5", output: "2 1 4 3 5" },
...
fn main() {
    ...
    // ==================== HARD #2: Merge K Sorted Lists ====================
    {
        ...
        examples: [
            { title: "Example 1", input: "3\n3 1 4 5\n3 1 3 4\n2 2 6", output: "1 1 2 3 4 4 5 6", explanation: "Lists: [1->4->5], [1->3->4], [2->6]. Merged sorted: 1->1->2->3->4->4->5->6." },
            { title: "Example 2", input: "1\n0", output: "" }
        ],
        testcases: [
...
fn main() {
    ...
    // ==================== HARD #3: LRU Cache Operations ====================
    {
        ...
        examples: [
            { title: "Example 1", input: "2 10\nPUT 1 1\nPUT 2 2\nGET 1\nPUT 3 3\nGET 2\nPUT 4 4\nGET 1\nGET 3\nGET 4", output: "1 -1 -1 3 4" },
            { title: "Example 2", input: "1 3\nPUT 5 10\nGET 5\nGET 6", output: "10 -1" }
        ],
        testcases: [
            { input: "2 10\nPUT 1 1\nPUT 2 2\nGET 1\nPUT 3 3\nGET 2\nPUT 4 4\nGET 1\nGET 3\nGET 4", output: "1 -1 -1 3 4" },
            { input: "1 3\nPUT 5 10\nGET 5\nGET 6", output: "10 -1" },
            { input: "3 12\nPUT 1 10\nPUT 2 20\nPUT 3 30\nGET 1\nGET 2\nGET 3\nPUT 4 40\nGET 1\nGET 2\nGET 3\nGET 4", output: "10 20 30 -1 20 30 40" },
            { input: "2 6\nPUT 1 100\nPUT 2 200\nGET 1\nPUT 1 150\nGET 1\nGET 2", output: "100 150 200" },
            { input: "4 10\nPUT 1 1\nPUT 2 2\nPUT 3 3\nPUT 4 4\nGET 1\nGET 2\nPUT 5 5\nGET 3\nGET 4\nGET 5", output: "1 2 -1 4 5" },
            { input: "2 5\nGET 1\nPUT 1 10\nGET 1\nPUT 2 20\nGET 2", output: "-1 10 20" },
            { input: "1 5\nPUT 1 10\nPUT 2 20\nGET 1\nPUT 3 30\nGET 2", output: "-1 -1" },
            { input: "2 7\nPUT 2 1\nPUT 1 1\nPUT 2 3\nPUT 4 1\nGET 1\nGET 2", output: "-1 3" },
            { input: "3 10\nPUT 1 1\nPUT 2 2\nGET 2\nPUT 3 3\nGET 1\nPUT 4 4\nGET 3\nGET 2\nGET 4", output: "2 1 3 2 4" },
            { input: "5 15\nPUT 1 1\nPUT 2 2\nPUT 3 3\nPUT 4 4\nPUT 5 5\nGET 1\nGET 2\nGET 3\nGET 4\nGET 5\nPUT 6 6\nGET 1\nGET 2\nGET 3\nGET 6", output: "1 2 3 4 5 -1 2 3 6" }
        ],
        codesnippets: {
            cpp: `#include <bits/stdc++.h>
using namespace std;
...
fn main() {
    ...
    // ==================== HARD #4: Serialize and Deserialize List ====================
    {
        ...
        examples: [
            { title: "Example 1", input: "5\n1 2 3 4 5\n4 0 -1 1 2", output: "1 2 3 4 5\n4 0 -1 1 2", explanation: "Original list is successfully serialized, deserialized, and matched." },
        ...
        testcases: [
            ...
            { input: "8\n1 2 3 4 5 6 7 8\n7 6 5 4 3 2 1 0", output: "1 2 3 4 5 6 7 8\n7 6 5 4 3 2 1 0" }
        ],
        codesnippets: {
            cpp: `#include <bits/stdc++.h>
using namespace std;
...
fn main() {
    ...
    // ==================== HARD #5: Flatten Multi-level Doubly Linked List ====================
    {
        ...
        examples: [
            { title: "Example 1", input: "6 1\n1 1 2 -1 -1\n2 2 3 1 5\n3 3 4 2 -1\n4 4 -1 3 -1\n5 5 6 -1 -1\n6 6 -1 5 -1", output: "1 2 5 6 3 4", explanation: "Child list of 2 is 5<->6. Flattened: 1<->2<->5<->6<->3<->4." },
            { title: "Example 2", input: "3 1\n1 10 -1 -1 2\n2 20 -1 -1 3\n3 30 -1 -1 -1", output: "10 20 30" }
        ],
        testcases: [
            { input: "6 1\n1 1 2 -1 -1\n2 2 3 1 5\n3 3 4 2 -1\n4 4 -1 3 -1\n5 5 6 -1 -1\n6 6 -1 5 -1", output: "1 2 5 6 3 4" },
            { input: "3 1\n1 10 -1 -1 2\n2 20 -1 -1 3\n3 30 -1 -1 -1", output: "10 20 30" },
            { input: "1 1\n1 42 -1 -1 -1", output: "42" },
            { input: "4 1\n1 1 2 -1 3\n2 2 -1 1 -1\n3 3 4 -1 -1\n4 4 -1 3 -1", output: "1 3 4 2" },
            { input: "5 1\n1 1 2 -1 -1\n2 2 3 1 4\n3 3 -1 2 -1\n4 4 5 -1 -1\n5 5 -1 4 -1", output: "1 2 4 5 3" },
            { input: "7 1\n1 1 2 -1 -1\n2 2 3 1 4\n3 3 -1 2 6\n4 4 5 -1 -1\n5 5 -1 4 -1\n6 6 7 -1 -1\n7 7 -1 6 -1", output: "1 2 4 5 3 6 7" },
            { input: "2 1\n1 10 -1 -1 2\n2 20 -1 1 -1", output: "10 20" },
            { input: "3 1\n1 1 2 -1 -1\n2 2 -1 1 3\n3 3 -1 -1 -1", output: "1 2 3" },
            { input: "5 1\n1 1 2 -1 -1\n2 2 -1 1 3\n3 3 -1 2 4\n4 4 -1 3 5\n5 5 -1 4 -1", output: "1 2 3 4 5" },
            { input: "8 1\n1 1 2 -1 -1\n2 2 3 1 4\n3 3 -1 2 -1\n4 4 5 -1 -1\n5 5 -1 4 6\n6 6 7 -1 -1\n7 7 8 -1 -1\n8 8 -1 7 -1", output: "1 2 4 5 6 7 8 3" }
        ],
        codesnippets: {
            cpp: `#include <bits/stdc++.h>
using namespace std;
