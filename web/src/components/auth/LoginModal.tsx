...
export function LoginModal() {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div className="w-full max-w-[340px] rounded-[24px] border border-white/10 bg-[#121212] p-8 relative flex flex-col min-h-[400px]">
                <button
                    onClick={closeModal}
                ...
                <div className="flex flex-col items-center text-center mt-2 mb-8">
                    ...
                    <p className="text-sm text-gray-400 mt-2">Sign in to continue to Campus Lab</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5 flex-1 flex flex-col">
                    ...
                    <div className="mt-auto pt-6">
                        <button
                            type="submit"
                            className="w-full bg-white text-black hover:bg-gray-200 font-medium py-2.5 rounded-xl text-sm transition-colors"
                        >
                            Sign In
                        </button>
