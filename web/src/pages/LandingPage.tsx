        ...
        <div className="min-h-screen bg-white text-gray-900 font-sans selection:bg-[#3E6FC3]/20 overflow-x-hidden">
            ...
            <main className="relative z-10 w-full pt-16">
                ...
                <section className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 text-center pt-16 pb-32 relative">
                    ...
                    >
                        Join an exclusive competitive programming ecosystem for RCPIT students. Master algorithms through curated problem sets, battle in real-time contest rooms with peers, and track your progress on the campus leaderboard to become placement-ready.
                    </motion.div>
                    ...
                    >
                        <button 
                            onClick={() => isLoggedIn ? navigate('/practice') : openModal('signup')}
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="bg-white rounded-[32px] border border-gray-100 shadow-[0_16px_48px_rgba(0,0,0,0.04)] p-8 w-full max-w-[440px] relative overflow-hidden">
                                ...
                                <div className="flex items-center justify-between mb-8">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-extrabold text-gray-900 text-lg tracking-tight mb-0.5">Room: Weekly Sprint</h4>
                                            <p className="text-sm text-gray-400 font-medium">ID: RCPIT-2026</p>
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between p-4 rounded-[20px] border border-[#F0F2F6] bg-white shadow-[0_4px_20px_-4px_rgba(0,0,0,0.03)] hover:shadow-[0_10px_30px_rgba(0,0,0,0.05)] hover:border-slate-200 transition-all duration-300">
                                        ...
                                        <span className="font-mono font-bold text-[#3E6FC3] bg-[#EBF2FC] px-3 py-1 rounded-[8px] text-sm">850 pts</span>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between p-4 rounded-[20px] border border-[#F0F2F6] bg-white shadow-[0_4px_20px_-4px_rgba(0,0,0,0.03)] hover:shadow-[0_10px_30px_rgba(0,0,0,0.05)] hover:border-slate-200 transition-all duration-300">
                                        ...
                                        <span className="font-mono font-bold text-[#475569] text-sm pr-1">720 pts</span>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between p-4 rounded-[20px] border border-[#F0F2F6] bg-white shadow-[0_4px_20px_-4px_rgba(0,0,0,0.03)] hover:shadow-[0_10px_30px_rgba(0,0,0,0.05)] hover:border-slate-200 transition-all duration-300">
                                        ...
                                        <span className="font-mono font-bold text-[#475569] text-sm pr-1">650 pts</span>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between p-4 rounded-[20px] border border-[#F0F2F6] bg-white shadow-[0_4px_20px_-4px_rgba(0,0,0,0.03)] hover:shadow-[0_10px_30px_rgba(0,0,0,0.05)] hover:border-slate-200 transition-all duration-300">
                                        ...
                                        <span className="font-mono font-bold text-[#475569] text-sm pr-1">590 pts</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed font-medium">
                                Learning is better together. Instantly generate private contest rooms, invite your peers, and battle it out in real-time coding challenges. Perfect for late-night college study sessions.
                            </p>
                            <button onClick={() => isLoggedIn ? navigate('/contest') : openModal('signup')} className="text-white bg-[#3E6FC3] hover:bg-[#325a9e] px-8 py-3.5 rounded-xl font-bold transition-all shadow-lg shadow-blue-500/25 flex items-center gap-2">
                ...
                <section className="bg-[#fafcff] py-24 border-y border-gray-100 relative z-20">
                    <div className="mx-auto max-w-6xl px-4">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Why Choose Campus Lab?</h2>
                            <p className="text-gray-500 max-w-2xl mx-auto text-lg">
                                In this project, we've focused on what truly matters: problem solving, real-time contest rooms, and AI mentor assistance to transform you into an elite developer.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-md transition-all group">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-3">AI Mentor Assistance</h3>
                                <p className="text-gray-500 text-sm leading-relaxed">Built right into this project, our AI mentor helps debug your code and explain complex logic without spoon-feeding the answers.</p>
                            </div>
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-md transition-all group">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-3">Contest Rooms</h3>
                                <p className="text-gray-500 text-sm leading-relaxed">A core feature of this platform. Create rooms and compete with your friends on custom problem sets in real time.</p>
                            </div>
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-md transition-all group">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-3">Focused Problem Solving</h3>
                                <p className="text-gray-500 text-sm leading-relaxed">Extensive practice sheets designed specifically to improve algorithmic problem solving and ace coding interviews.</p>
                            </div>
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-md transition-all group">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-3">Placement Ready</h3>
                                <p className="text-gray-500 text-sm leading-relaxed">Master the exact algorithmic patterns frequently asked in interviews at top product-based companies.</p>
                            </div>
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-md transition-all group">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-3">Faculty Dashboard</h3>
                                <p className="text-gray-500 text-sm leading-relaxed">Educators can easily track student progress, review submissions, and manage internal assessments seamlessly.</p>
                            </div>
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-md transition-all group">
                                ...
                                <p className="text-gray-500 text-sm leading-relaxed">Follow guided, step-by-step learning paths tailored for beginners up to advanced competitive programmers.</p>
                            </div>
                        </div>
                    </div>
                </section>
